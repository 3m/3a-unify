  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20">
      <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-md border-b border-border">
        <div className="p-6">
          <h1 className="text-3xl font-bold bg-gradient-to-r from-primary to-primary/70 bg-clip-text text-transparent">Events</h1>
        </div>
      </div>
      <div className="max-w-4xl mx-auto p-6">
        <div className="bg-card/50 backdrop-blur-sm rounded-2xl shadow-lg border-0 p-8">
          <div className="text-center">
            ...
            <h2 className="text-xl font-semibold text-foreground mb-2">No events scheduled</h2>
